...
try:
    ...
    prox= requests.get('https://pastebin.com/2ceqHj0i').text
...
\033[1;92m    | [\033[1;31;1m©\033[1;92m]  [\033[1;31;1m©\033[1;92m] |
 ...
 \033[1;92m   |  [\33[1;33m====\033[1;92m]  | [+] HACKERS PAKISTANI [+]

\033[1;92m╔══o00════════00o═════════════════════════╗

\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mAuthor    :  \033[1;92m JAIKUMAR           \033[1;31;1m █

\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mWhatsapp  :  \033[1;92m Black Gold          \033[1;31;1m █

\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mWhatsapp  : \033[1;92m  +923312734753          \033[1;31;1m █
...
def hasil(ok,cp):
    ...
    if len(ok) != 0 or len(cp) != 0:
        ...
        print(f'\n%s══════════════════════════════════════════\n [%s✓%s] %sCracking By JAIKUMAR Usercrack...\n%s══════════════════════════════════════════'%(N,H,N,H,N))
        ...
        if cek_cp =="":
            ...
            if ww in ("Y","y","ya"):
                ...
                print(f" {N}[{H}•{N}] Password example : {H}jaikumar123{N}")
            ...
            for pw in pasw:
                ...
                if "c_user" in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        wrt = '[JAIKUMAR-CP] %s • %s • %s %s %s' % (user,pw,day,month,year)
